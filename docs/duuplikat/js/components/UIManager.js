...
class UIManager {
        ...
        const resultHTML = `
            <div class="analysis-result">
                ...
                <div class="result-item">
                    ...
                    <span class="value emotion-${analysis.emotion}">${analysis.emotion}</span>
                </div>
                <div class="result-item">
    ...
    updateEmotionDisplay(data) {
        if (this.elements.currentEmotion) {
            this.elements.currentEmotion.textContent = data.emotion;
            this.elements.currentEmotion.className = `emotion-display ${data.emotion}`;
        }
        ...
        if (this.elements.submitDataBtn) {
            const hasValidEmotion = data.emotion && data.emotion !== 'neutral';
    ...
    addToHistory(data, source) {
        ...
        historyItem.innerHTML = `
            ...
            <div class="history-content">
                <div class="history-emotion emotion-${data.emotion}">
                    ${data.emotion}
                </div>
